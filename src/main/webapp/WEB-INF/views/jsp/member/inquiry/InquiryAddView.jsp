...
<section id="root">
  ...
  <section id="memberSection">
    <div id="content" class="bg">
        ...
        <div class="inquiry-container">
          <div class="inquiry-title one-line">
            ...
            <div class="one-line">
              ...
              <input id="titleVal" maxlength="25" type="text" class="info-item bg__white text__black box__l" placeholder="제목을 입력하세요">
            </div>
            <div class="one-line">
      ...
      <div class="btn-container one-line inquiry-add-container">
