...
function fetchSellingCards(memberNo) {
  $.ajax({
    ...
    success: function(cards) {
      ...
      const cardHTML = `         
        ...
        <div class="bg__white">
          <div class="list-container list-content one-line">
            ...
            <div class="list-item box__m" id="benefit-container"></div>
            <div class="list-item box__m text__center">
              ${formatDate(card.SELLINGDATE)} <!-- date formatting function must be implemented -->
            </div>
            <div class="list-item box__l text__center">${card.MEMBERCARDNO}</div>
      ...
      $("#root").append(`<input id='sellingCardNo' type='hidden' value='${card.SELLINGCARDNO}' />`)
