...
public class MemberAccountBookApiController {
  ...
  @GetMapping("/list")
  public ResponseEntity<List<AccountBookVo>> getRecentAccountBooks(@RequestParam int memberNo, @RequestParam(defaultValue = "1") int limit) { // 기본값으로 10개 설정
  ...
  public List<String> getMinusCategories() {return accountBookService.getMinusCategoryList();}
  ...
  @GetMapping("/detail")
  public ResponseEntity<?> getAccountBookDetail(@RequestParam("accountBookNo") int accountBookNo, @RequestParam("memberNo") int memberNo) {
  ...
  public ResponseEntity<List<AccountBookVo>> getMonthlyExpenseBook(@RequestParam int memberNo, @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) Date startDate, @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) Date endDate) {
  ...
  public ResponseEntity<List<AccountBookVo>> getMonthlyPayback(@RequestParam String startDate, @RequestParam String endDate, @RequestParam int memberNo) {
  ...
  public ResponseEntity<List<AccountBookVo>> getCardDetail(@RequestParam int memberNo, @RequestParam(required = false) Integer categoryNo, @RequestParam(required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate startDate) {
