...
@RestController
@RequestMapping("/member/salesDashboard")
public class MemberSellingCardController {
  private final Logger log = LoggerFactory.getLogger(MemberSellingCardController.class);
  private final String logTitleMsg = "==MemberSellingCardController==";
